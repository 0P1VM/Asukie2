...
if ( !['752954404986159275','719944880800923690', '268403900355313674'].includes(message.author.id) && !message.member.hasPermission('MANAGE_CHANNELS'))
